...
public class TransferActivityOB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transfer_ob);
    ...
    public  void noFundsMsg() {
        ...
        Toast.makeText(TransferActivityOB.this, "Insufficient funds! Please enter a valid transfer amount and try again!", Toast.LENGTH_LONG).show();
    }//end noFundsMsg
    //function to prompt user for input
    public  void noAmountMsg() {

        Toast.makeText(TransferActivityOB.this, "Nothing entered! Please enter transfer amount and try again!", Toast.LENGTH_LONG).show();
    }//noAmountMsg
