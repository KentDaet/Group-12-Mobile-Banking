...
public class TransactionActivityOB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaction_ob);
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(WithdrawET.getText())) {
                    ...
                    //there's not enough money in the account, prompt user for valid input
                        ...
                        Toast.makeText(TransactionActivityOB.this, "Insufficient funds! Please enter a valid withdraw amount and try again!", Toast.LENGTH_LONG).show();
                }//end 1st if
                //withdraw filed is empty, prompt user to enter withdraw amount
                else {
                    Toast.makeText(TransactionActivityOB.this, "Nothing entered! Please enter withdraw amount and try again!", Toast.LENGTH_LONG).show();
                }
